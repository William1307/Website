...
date: 2025-12-08
excerpt: "Reprendre le contrôle total de nos requêtes internet : installation de Pi-hole (blocage de pub à l'échelle du réseau) couplé à Unbound (résolveur DNS récursif) sur un Raspberry Pi 5, pas à pas."
...
![Unbound DNS Settings](./10unbound_dns_settings.png)
...
![Pi-hole DNS Settings](./11DNS_windows_config.png)
